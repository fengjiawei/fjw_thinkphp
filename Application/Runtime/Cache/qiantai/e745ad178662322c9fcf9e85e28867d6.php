                    ...
                    <div class="text-right">
                        <div class="A">
                            ...
                            <div class="col-md-12" style="padding-top: 10PX;">
                                ...
                                <div class="col-md-8">
                                    <input id="phone" name="phone" type="text" class="form-control"
                                           placeholder="请输入法定代表人或授权委托人手机号码">
                                </div>
                            ...
                            <div class="col-md-12" style="padding-top: 10PX;padding-bottom: 10PX;">
                                ...
                                <div class="col-md-3">
                                    <div class="text-left">
                                        <button id="yzm" onclick="time()" type="button" class="btn btn-default"
                                                style="align-self: auto;border: 1px solid gainsboro">获取验证码</button>
