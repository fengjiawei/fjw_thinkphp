		...
		<div class="mui-content">
			<div class="mui-content-padded">
				...
				<p style="text-align: center;">
					<img src="/Uploads/img/jifen/tu4.jpg" data-preview-src="" data-preview-group="1">
				</p>
					<table class="table table-bordered" style="font-size: 15px;">
								<tr>
									<td colspan="1">商品名称：</td>
									<td colspan="3">品牌毛巾</td>
								</tr>
								<tr>
									<td colspan="1">所需积分：</td>
									<td colspan="3">1500分</td>
								</tr>
								<tr>
						...
						<button id="toastBtn" type="button" class="mui-btn mui-btn-primary mui-btn-block" style="font-weight: bold;">兑     换</button>
			</div>
		</div>
	</body>
