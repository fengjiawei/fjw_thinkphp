...
<div id="step1" style="width: 100%;margin-top: 20px;display: block">
    ...
    <div class="col-md-6">
        <form id="defaultForm" method="post" class="form-horizontal">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label">行驶证</label>

                <div class="col-sm-7">
                    <input id="img4" type="file" class="form-control" name="transportImg"/>
                    <input type="text" name="transportImage" id="img41" style="display: none">

                    <div class="div_fl_3" id="transportImgDiv">
                        <img id="transportImages" style="width: 100%;height: 100%" src="/Uploads/img/logo.jpg"
                             alt="行驶证实力图">
...
//            console.log(this.result.replace(/^data:image\/(png|jpg|jpeg);base64,/, ""));
    ...
    $('#img4').change(function (data) {
        readFile(this, $(this).attr('id'))
        var objUrl = getObjectURL(this.files[0]);
        if (objUrl) {
            $('#transportImages').attr('src', objUrl)
        }
    })
