        ...
        <ul class="list-group" style="margin-top: 20px;width: 60%">
            ...
            <div class="media">
                <div class="media-left media-middle">
                    <a href="#">
                        <img class="media-object" src="/Uploads/img/tx.png">
                    </a>
                </div>
                <div class="media-body" style="margin-top: 20px;vertical-align: middle">
                    ...
                    <!--<label>手机号码：</label><?php echo ($list["account"]); ?>-->
                </div>
            </div>
            ...
            <li class="list-group-item" style="margin-top: 10px">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?php if($list["authentication"] == 'authed'): ?><a class="btn btn-success" href="javascript:void(0)">已认证</a>
                            <?php else: ?>
                            <a class="btn btn-danger" href="javascript:void(0)" onclick="auth()">立即认证</a><?php endif; ?>
                        <script>
                            function auth() {
            ...
            <li class="list-group-item">
                <div class="row">
                    ...
                    <div class="col-md-4"></div>
                    <div class="col-md-4">
                        <a class="btn btn-danger" href="javascript:void(0)" onclick="resPw()">修改密码</a>
                    </div>
            ...
            <ul class="list-group" style="width: 60%">
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-md-4"></div>
                        <div class="col-md-4">
                            <button class="btn btn-primary btn-lg" type="button" onclick="save()">&nbsp;编辑保存&nbsp;</button>
                        </div>
                        <div class="col-md-4"></div>
                    </div>
                </li>
