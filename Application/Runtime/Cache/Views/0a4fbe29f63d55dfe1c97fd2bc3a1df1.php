...
<div class="panel panel-default">
    ...
    <div class="list-group">
        <!-- for -->
        <?php $__FOR_START_1024034262__=0;$__FOR_END_1024034262__=5;for($i=$__FOR_START_1024034262__;$i < $__FOR_END_1024034262__;$i+=1){ ?><a href="#" class="list-group-item">使用for标签循环了{<?php echo ($i+1); ?>}次了</a><?php } ?>
    </div>
</div>
...
<!--</div>-->
    ...
    <div class="alert alert-success">
        ...
        <strong>Success</strong> 重载Header block
            ...
            <!-- css -->
            <!-- <link rel="stylesheet" type="text/css" href="/fjw_thinkphp/Public/css/bootstrap.css" /> -->
